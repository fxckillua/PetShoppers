...
class PetiscosGatosView extends StatefulWidget {
  @override
  _PetiscosGatosViewState createState() => _PetiscosGatosViewState();
}

class _PetiscosGatosViewState extends State<PetiscosGatosView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Petiscos para Gatos'),
      ),
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('produtos')
            .where('categoria', isEqualTo: 'Petiscos')
