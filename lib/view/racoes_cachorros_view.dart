...
class RacoesCachorrosView extends StatefulWidget {
  @override
  _RacoesCachorrosViewState createState() => _RacoesCachorrosViewState();
}

class _RacoesCachorrosViewState extends State<RacoesCachorrosView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Rações para Cachorros'),
      ),
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('produtos')
            .where('categoria', isEqualTo: 'Cachorros')
            .snapshots(),
